...
if (process.env.NODE_ENV === 'production') {
    corsOptions = {
        origin: process.env.PROD_ORIGIN || 'https://vercel.com/stswengs18s-projects/unbound-stsweng',
        credentials: true,
    ...
    corsOptions = {
        origin: process.env.DEV_ORIGIN || 'https://unbound-stsweng-git-dev-branch-stswengs18s-projects.vercel.app/',
        credentials: true,
        methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
        allowedHeaders: ['Content-Type', 'Authorization']
    };
